...
time ansible-playbook -i inventory --extra-vars "@group_vars/all/test-env-all.yml" \
-e "snapshot_name=03-after-mariadb-config" \
/data/projects/ansible2-6/pb/ansible-testing_environment/snapshot-create.yml
...
/data/projects/ansible2-6/pb/ansible-testing_environment/snapshot-create.yml \
--extra-vars "@group_vars/all/test-env-all.yml" -e "snapshot_name=04-after-icinga-config"
...
#ansible-playbook \
#--extra-vars "@/data/projects/ansible2-6/pb/docker-icinga3/group_vars/all/test-env-all.yml" \
#--extra-vars "snapshot_name=01-after-update" \
#/data/projects/ansible2-6/pb/ansible-testing_environment/snapshot-revert.yml
