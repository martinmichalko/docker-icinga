...
time ansible-playbook -i /data/projects/ansible2-6/pb/docker-icinga/inventory create-update-config.yml \
--extra-vars "@/data/projects/ansible2-6/pb/docker-icinga/group_vars/all/test-env-all.yml" \
-e 'ansible_python_interpreter=/usr/bin/python'

cd /data/projects/ansible2-6/pb/docker-icinga/
time ansible-playbook -i inventory packages-req.yml docker.yml docker-registry.yml

time ansible-playbook /data/projects/ansible2-6/pb/ansible-testing_environment/snapshot-create.yml --extra-vars "@/data/projects/ansible2-6/pb/docker-icinga/group_vars/all/test-env-all.yml" --extra-vars "snapshot_name=02-after-docker-reg"
